            ...
            <Stack spacing={12}>
                <Box>
                    <Text mb={4} align="justify">
                        I'm a software engineer based in Jakarta, work mainly on backend. I also enjoy working on frontend, building both web and mobile applications. I like to solve technical problems, analyse the business process, 
