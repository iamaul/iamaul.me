            ...
            <Stack spacing={12}>
                <Box>
                    <Text mb={4} align="justify">
                        ...
                        and also I really enjoy working on front-end, building both web and mobile applications. I like to solve technical problems, analyse the business process, 
